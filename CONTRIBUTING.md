...
* GitHub Issues: <https://github.com/bootstrapphp/bootstrapphp/issues>
...
* bootstrapphp/bootstrapphp follows the **[PSR-12 coding standard][psr-12]**. Please
  ensure your code does, too.
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  bootstrapphp/bootstrapphp has Travis CI automatically running tests for pull requests.
...
```
composer BTP:test:all
```


[github]: https://github.com/bootstrapphp/bootstrapphp
[issues]: https://github.com/bootstrapphp/bootstrapphp/issues
[pull requests]: https://github.com/bootstrapphp/bootstrapphp/pulls
